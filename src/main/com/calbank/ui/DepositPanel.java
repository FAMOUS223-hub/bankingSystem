...
public final class DepositPanel extends JPanel implements MainContentPanel.Refreshable {
    ...
    public DepositPanel(AccountService accountService, TransactionService transactionService) {
    ...
    public void refresh() {
        ...
        ThemeManager.styleSuccessButton(depositBtn);
    ...
    private void handleDeposit() {
        ...
        try {
            Transaction tx = transactionService.deposit(accountId, Double.parseDouble(amount), desc, catId);
            if (tx != null) {
                errorLabel.setText(" ");
                ToastNotification.showSuccess(this,
                    "Deposited " + TransactionUtils.formatCurrency(Double.parseDouble(amount))
